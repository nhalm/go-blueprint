...
Output lands in `internal/api/docs/`. To serve the spec, blank-import that package (`_ "github.com/yourorg/myapp/internal/api/docs"`) so `swag`'s init function registers itself.
